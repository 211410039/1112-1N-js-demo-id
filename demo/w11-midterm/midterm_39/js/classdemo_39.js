const showClassDemo = (code) => {
  ...
  switch (code) {
    ...
    case 'mid-p1-39':
      ...
      break;
    case 'mid-p2-39':
      showDemo.innerHTML = `<iframe src='./midterm_39/p2_39/p2_39.html' width="100%" height="100%" />`;
      break;
    case 'mid-p3-39':
      showDemo.innerHTML = `<iframe src='./midterm_39/p3_39/p3_39.html' width="100%" height="100%" />`;
      break;
  }
};
